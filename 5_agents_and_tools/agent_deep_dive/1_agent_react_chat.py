...
from langchain_core.tools import tool  # <-- Notice the lowercase 'tool' decorator
...
def search_wikipedia(query: str) -> str:
    ...
    from wikipedia import summary
    try:
        # The model reads this argument name ('query') natively now!
        return summary(query, sentences=2)
    except Exception:
...
# --- 3. Define System Context & Memory ---
system_message = (
    "You are an AI assistant that can provide helpful answers using available tools.\n"
    "If you need information, you must use the following tools: get_current_time and search_wikipedia."
)
